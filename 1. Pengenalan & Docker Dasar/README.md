...
### Instalasi
#### Windows
1. Pastika bahwa WSL2 sudah terinstall, jika belum, ikuti langkah-langkah di https://pureinfotech.com/install-windows-subsystem-linux-2-windows-10/ (cek versi win10 anda terlebih dahulu, jika versi 2004 ke atas, langkah-langkahnya di atas, jika versi 1909 ke bawah, scroll ke bawah)
